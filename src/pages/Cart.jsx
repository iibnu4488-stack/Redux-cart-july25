   ...
   const checkout = ()=>{
    ...
    navigate('/')
     Swal.fire({
         ...
         text: 'Thankyou for purshasing with us!!!',
         icon: 'success',
          ...
          <div className="row mt-5">
            <div className="col-md-8 border rounded p-5">
                ...
                <tbody>
                  {
                    ...
                    <td><div className="d-flex">
                      ...
                      <button onClick={()=>dispatch(incrementCartItem(product))}  className="btn fs-5 fw-bold">+</button>
                      </div>
                      </td>
               ...
               <div className="float-end me-3">
                  <button onClick={()=>dispatch(emptyCart())} className="btn btn-danger m-2">EMPTY CART</button>
